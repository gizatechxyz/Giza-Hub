...
dev_passphrase = os.environ.get("DEV_PASSPHRASE") ## Make sure to edit your .env file with your passphrase
network = "ethereum:mainnet_fork:foundry"  ## We ask the Ape Framework to locate our forked mainnet
...
if __name__ == "__main__":
    ...
    with accounts.use_sender("pendle-agent"):
        ...
        eETH_LP.deposit(value= eETH_mint_amount, max_fee = 10**10) ## Deposit 8 ETH to get eETH
        print(f"Approving eETH to wrap to weETH")
        eETH.approve(weETH.address,eETH_mint_amount, max_fee = 10**10)  ## Approve eETH to be wrapped to weETH
